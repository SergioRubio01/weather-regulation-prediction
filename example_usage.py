...
from config import (
    ...
    RandomForestConfig, LSTMConfig, EnsembleConfig,
    ModelType, Optimizer, Activation, Loss
)
from config_parser import ConfigParser
from config_utils import (
    load_config, save_config, create_experiment_suite,
    compare_configs, estimate_training_time, optimize_for_hardware
)

# Model imports
from model import Dly_Classifier, run_quick_experiment, compare_pipelines
...
def example_modular_pipeline():
    ...
    print(f"HTML report generated in Output directory")
...
def example_data_pipeline():
    ...
    y = data['features']['has_regulation'] if 'has_regulation' in data['features'].columns else np.random.randint(0, 2, len(data['features']))
