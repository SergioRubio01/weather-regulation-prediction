...
class RandomForestConfig:
    ...
    max_features: list[str | float] = field(default_factory=lambda: ["auto", "sqrt", 0.5])
    bootstrap: bool = True
    n_jobs: int = -1
    verbose: int = 0
...
class ExperimentConfig:
    ...
    random_forest: RandomForestConfig | None = field(default_factory=RandomForestConfig)
    lstm: LSTMConfig | None = field(default_factory=LSTMConfig)
    cnn: CNNConfig | None = field(default_factory=CNNConfig)
    gru: GRUConfig | None = field(default_factory=GRUConfig)
    transformer: TransformerConfig | None = field(default_factory=TransformerConfig)
    ensemble: EnsembleConfig | None = field(default_factory=EnsembleConfig)
    autoencoder: AutoencoderConfig | None = field(default_factory=AutoencoderConfig)
