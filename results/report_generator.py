...
from results.results_manager import ExperimentResult
...
"""
    ...
    def _prepare_report_data(
        self, experiment: ExperimentResult, include_visualizations: bool
    ) -> dict[str, Any]:
    ...
    def _generate_conclusions(self, experiment: ExperimentResult) -> str:
        ...
        conclusions.append(
            f"The {experiment.best_model} model achieved the highest accuracy "
    ...
    def _generate_latex_report(self, data: dict[str, Any], output_path: str | None) -> str:
    ...
    def _generate_powerpoint_report(self, data: dict[str, Any], output_path: str | None) -> str:
        """Generate PowerPoint presentation"""
        if not PPTX_AVAILABLE:
            raise ImportError(
                "python-pptx is required for PowerPoint generation. Install with: pip install python-pptx"
            )
...
def generate_experiment_report(
    experiment: ExperimentResult, format: str = "html", output_dir: str = "./reports"
) -> str:
...
def generate_comparison_report(
    experiments: list[ExperimentResult], output_path: str = "./reports/comparison_report.html"
) -> str:
