...
dates = download_TAFs(Input_file='.\Data\TAF\TAF_ejemplo.txt',
              output_file='.\Data\TAF\TAF_ejemplo_formatted.txt')
valid_from_date = filter_eTAFs(Input_file='.\Data\TAF\TAF_ejemplo_formatted.txt',
                               Visibility_Nicolas='.\Data\TAF\Visibility predictions TAF.csv',
                               Ceiling_Nicolas='.\Data\TAF\ceiling predictions TAF.csv',
                               Output_file='.\Data\TAF\TAF_output.csv')
