...
class TestConfigClasses(unittest.TestCase):
    ...
    def test_data_config_datetime_conversion(self):
        ...
        config = DataConfig(time_init="2020-01-01 00:00:00", time_end="2020-12-31 23:59:59")
    ...
    def test_experiment_config_creation(self):
        ...
        config = ExperimentConfig(name="test_experiment", description="Test description")
...
class TestConfigParser(unittest.TestCase):
    ...
    def test_load_yaml_config(self):
        ...
        config_dict = {
            ...
            "data": {"airports": ["EGLL"], "time_delta": 30, "test_size": 0.2},
        }
    ...
    def test_load_json_config(self):
        ...
        config_dict = {
            ...
            "data": {"airports": ["LSZH"], "time_delta": 60},
        }
    ...
    def test_merge_configs(self):
        ...
        override_dict = {"name": "merged_config", "data": {"airports": ["LFPG"], "test_size": 0.3}}
    ...
    def test_generate_hyperparameter_grid(self):
        ...
        config = create_default_config()
        config.lstm = LSTMConfig(units=[50, 100], epochs=[30, 60], batch_size=[32])
