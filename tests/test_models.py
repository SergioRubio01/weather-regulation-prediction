...
from config import (
    RandomForestConfig, LSTMConfig, CNNConfig, RNNConfig, FNNConfig,
    GRUConfig, TransformerConfig, EnsembleConfig, AutoencoderConfig
)
...
@pytest.mark.parametrize("model_class,config_class,config_params", [
