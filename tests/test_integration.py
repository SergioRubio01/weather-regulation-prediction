...
class TestConfigurationIntegration:
    ...
    def test_config_to_model_integration(self):
        ...
        from config import RandomForestConfig, LSTMConfig
    ...
    def test_config_merging_integration(self):
        ...
        override_config = {
            ...
            'models': {
                'random_forest': {
                    'n_estimators': 20  # Override n_estimators
                },
                'lstm': {  # Add new model
                    'units': 32,
                    'epochs': 10
...
class TestDataFlowIntegration:
    ...
    def test_data_loader_to_validator_integration(self, sample_pipeline_data):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            is_valid, errors = schema_validator.validate_schema(
                loaded_weather[['timestamp', 'temperature', 'pressure']], 
                expected_schema
            )
            assert is_valid
    ...
    def test_feature_engineering_to_preprocessing_integration(self, sample_pipeline_data):
        ...
        # Preprocessing
        from data.preprocessing import TimeSeriesScaler, CyclicalEncoder
        ...
        if 'hour' in enhanced_data.columns:
            cyclical_data = encoder.fit_transform(
                enhanced_data[['hour']], 
                periods={'hour': 24}
            )
